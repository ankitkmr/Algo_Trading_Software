...
def find_events(ls_symbols, d_data, df_bollinger):
     ...
     for s_sym in ls_symbols:
        for i in range(1, len(ldt_timestamps)):
            ...
            f_cutoff = -2.0
            if f_bollinger_today < f_cutoff and f_bollinger_yest >= f_cutoff and f_bollinger_market_today >= 1.5 :
                with open('orders7.csv', 'a') as fp:
...
if __name__ == '__main__':
    ...
    find_events(ls_symbols, d_data,df_bollinger = bollinger())
