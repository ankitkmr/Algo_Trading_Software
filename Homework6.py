...
def find_events(ls_symbols, d_data, df_bollinger):
     ...
     for s_sym in ls_symbols:
        for i in range(1, len(ldt_timestamps)):
            ...
            f_cutoff = -2.0
            if f_bollinger_today < f_cutoff and f_bollinger_yest >= f_cutoff and f_bollinger_market_today >= 1.2 :
...
if __name__ == '__main__':
    ...
    ep.eventprofiler(df_events, d_data, i_lookback=20, i_lookforward=20,
                 s_filename='homework6.pdf', b_market_neutral=True, b_errorbars=True,
                s_market_sym='SPY')
